        ...
        <section className="bg-primary py-16 md:py-24">
            <div className="mx-auto max-w-container px-4 md:px-8">
                <div className="mx-auto flex w-full max-w-3xl flex-col items-center text-center">
                    <span className="text-sm font-semibold text-brand-secondary md:text-md">{t("pricingSection.badge")}</span>
                    <h2 className="mt-3 text-display-md font-semibold text-primary md:text-display-lg">{t("pricingSection.title")}</h2>
                    <p className="mt-4 text-lg text-tertiary md:mt-6 md:text-xl">{t("pricingSection.subtitle")}</p>
                </div>
                <div className="mt-16 grid w-full grid-cols-1 gap-4 md:grid-cols-2 md:gap-8 md:mt-20 xl:grid-cols-3">
                    {plans.map((plan) => (
